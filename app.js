...
let jejuLatLng = new naver.maps.LatLng(33.3590628, 126.534361); // 제주 위도 경도
let seoulLatLng = new naver.maps.LatLng(37.4734848, 126.8776964); // 제주 위도 경도
let toJejuBtn = document.querySelector('.toJeju');
let toSeoulBtn = document.querySelector('.toSeoul');


toJejuBtn.addEventListener("click", (e) => {
    e.preventDefault();
